...
export class SistemaControlComponent implements OnInit {
  ...
  dibujar() {
    ...
    if (this.estado == 1) {
      ...
      //arrgloFlujos.push(posXsimbolo+5,posXsimbolo+5,posXsimbolo+5+anchoSimbolo-10,posYsimbolo+5+altoSimbolo-10-5,posYsimbolo+5,posYsimbolo+5+altoSimbolo-55,0,-1,anchoSimbolo-10,5,colorSimboloF)
      //Flujo(x_partida,x_ini,x_fin,y_partida,y_ini,y_fin,dx,dy,ancho,alto,color)
      //while (this.estado == 1)
      //animación flujo de 5px de ancho
      //arregloFlujos.push(new Flujo(34,34,86,90,90,91,1,0,5,32,colorSimboloF)); //para el del flujo de la izquierda
      //while (this.estado == 1){
      //  Flujo(34,34,86,90,90,91,1,0,5,32,colorSimboloF);
      //}
      //arregloFlujos.push(new Flujo(323,271,328,90,90,91,-1,0,5,32,colorSimboloF)) //para el flujo de la derecha
    }
